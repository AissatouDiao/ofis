      ...
      <div class="content">
        <div class="row">
          <div class="col-md-12">
            ...
            @endif
              <form action="{{url('updateprojet')}}" method="post" enctype="multipart/form-data">
           @csrf
                @method('PUT')
             ...
             <input type="hidden" name="id" value="{{ $projets->id }}">
              ...
              <input class="form-control" accept="image/gif, image/jpeg, image/png,image/jpg" type="file" name="image" id="image" value=" {!! old('$projets->image')!!}">
