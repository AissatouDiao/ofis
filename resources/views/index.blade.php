        ...
        <div class="page-wrapper">
                        ...
                        <div class="col-lg-6 offset-lg-1">
                            <div class="pl-lg-5">
                                ...
                                <div class="about-block">
                                    <div class="inner-box">
                                        <div class="text">
                                            <p>Nous sommes un groupe de jeunes personnes qui ont pris conscience du problème de l'assainissement, surtout dans le milieu rural. Dans cette zone, le manque de latrines dans les maisons, a d'énormes conséquences sur
                                                la population notamment la santé. C'est cela qui nous a poussé à penser à une solution qui pourrait régler ces problèmes, la plateforme OFIS(Merci de nous rendre visite ;))</p>
            ...
            <section class="causes-section sp-two">
                <div class="container">
                        ...
                        <div class="cause-block col-lg-4 col-md-6">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="text" style="height:200px;width:200px;">{!!Str::words($projet->description,50)!!}...</div><br>
                                    <!--Progress Levels-->
                    ...
                    <h5>
                        <div class="text-center"><a href="{{ url('projets') }}"> <button type="button" class="btn btn-info btn-block">Voir tous les projets</button></a></div>
                    </h5>
                </div>
            </section>
            ...
            <section class="news-section sp-two">
                <div class="container">
                    ...
                    <h5>
                        <div class="text-center "><a href="{{ url('blog') }}"><button type="button" class="btn btn-info btn-block">Voir tous les articles</button></a> </div>
                    </h5>
                </div>
            </section>
